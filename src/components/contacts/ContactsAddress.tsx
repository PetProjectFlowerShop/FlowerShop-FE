      ...
      <Stack spacing={6}>
        ...
        >
          ...
          <Typography variant="body1" sx={{ mt: 3 }}>
            Our studio is located at 12 Kvitkova St., Kyiv. If you're coming by metro, take the exit
            toward the city center—we are just a 5-minute walk away, right next to the central park.
            Look for the green awning and the scent of fresh peonies!
          </Typography>
        </Box>
      </Stack>
    </Stack>
